...
def get_batch(text_data1, text_data2, indices):
    ...
    for idx in indices:
        ...
        try: mask_indices.append(np.argwhere(np.array(encode_dict['input_ids']) == 103)[0][1])  # id of [MASK] is 103
        except IndexError:
